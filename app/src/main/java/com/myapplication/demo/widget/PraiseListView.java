...
public class PraiseListView extends TextView {
    ...
    private List<CircleBean.DataBean.ZhanListBean> datas;
    ...
    public List<CircleBean.DataBean.ZhanListBean> getDatas() {
        return datas;
    }
    public void setDatas(List<CircleBean.DataBean.ZhanListBean> datas) {
        this.datas = datas;
    ...
    public void notifyDataSetChanged(){
        ...
        if(datas != null && datas.size() > 0){
            ...
            CircleBean.DataBean.ZhanListBean item = null;
    ...
    private SpannableString setImageSpan(){
        ...
        imgSpanText.setSpan(new ImageSpan(BaseApplication.getInstance(), R.drawable.icon_praise, DynamicDrawableSpan.ALIGN_BASELINE),
